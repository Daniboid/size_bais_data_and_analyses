...
If using this data or code, please cite: `Larranaga, D., & Sereno, A.B. (2022) Bigger is really better:  Resolution of conflicting behavioral evidence for semantic size bias in a lexical decision task. *Under Review*`
